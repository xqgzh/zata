...
namespace Zata.Web.Basic
{
    class BasicHttpMethodResponse
    {
        ...
        public void ProcessResponse(HttpContext httpContext, HttpMethodProtocol httpMethodContext)
        {
            ...
            object o = httpMethodContext.Result;
            ...
            //    //压缩或者签名之后返回的结果, 类型为二进制
            //    httpContext.Response.AppendHeader("transfer-encoding", MediaTypes.Application.OctetStream);

            //if (IsCompressed)
            //    httpContext.Response.OutputStream.Write(zipPrefix, 0, zipPrefix.Length);
